<%-- 
    Document   : Home
    Created on : Jun 19, 2020, 10:04:14 AM
    Author     : sree
--%>
...
<html>
    ...
    <script src="automate-slideshow.js" type="text/javascript"></script>
    <style type="text/css">
    ...
    *{margin: 0;padding:0px}
	...
	<span id="Build" style="font-size:xx-large;font-family:sans-serif;margin-right:29%;text-decoration:underline">Fly In The Air</span>
    	...
    	<button class="btn btn-primary disabled"><a href="Login.jsp" style="text-decoration:none;color:white" target="_blank">LogIn</a></button>
        ...
        <div class="header">
                ...
                <div class="dropdown">
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        <a href="J3.jsp">Book Ticket</a>
                        <a href="J4.jsp">Cancel Ticket</a>
                        <a href="J2.jsp">My Bookings</a> 
                        <a href="Ad_Login.jsp">Admin Login</a>
                    </div>
                </div>
            </div>
	</div>
...
<div class="container">
   <img class="mySlides" src="flight1.jpg">
   <img class="mySlides" src="flight2.jpg">
   <img class="mySlides" src="flight3.jpg">
   <img class="mySlides" src="flight4.jpg">
   <img class="mySlides" src="flight5.jpg">
</div>
